...
const Banner = () => {
  return (
    <div className="w-full max-w-7xl my-5 px-2 mx-auto">
      <div className="relative rounded-xl overflow-hidden shadow-lg">
        ...
        />
        <div className="absolute inset-0 bg-black/30 flex flex-col items-center justify-center text-center sm:text-start  px-4">
